package com.cuixx.es.common.entity.search.utils;

import com.cuixx.es.common.entity.search.SearchOperator;
import com.cuixx.es.common.entity.search.Searchable;
import com.cuixx.es.common.entity.search.exception.InvalidSearchPropertyException;
import com.cuixx.es.common.entity.search.exception.InvalidSearchValueException;
import com.cuixx.es.common.entity.search.exception.SearchException;
import com.cuixx.es.common.entity.search.filter.AndCondition;
import com.cuixx.es.common.entity.search.filter.Condition;
import com.cuixx.es.common.entity.search.filter.OrCondition;
import com.cuixx.es.common.entity.search.filter.SearchFilter;
...
public final class SearchableConvertUtils {
     ...
     * value="com.cuixx.es.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.cuixx.es.common.entity.search.utils." +
