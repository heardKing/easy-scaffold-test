...
import com.cuixx.es.sys.user.entity.UserOrganizationJob;
import com.cuixx.es.sys.user.entity.UserStatus;
import com.cuixx.es.sys.user.exception.UserBlockedException;
import com.cuixx.es.sys.user.exception.UserNotExistsException;
import com.cuixx.es.sys.user.exception.UserPasswordNotMatchException;
import com.cuixx.es.sys.user.repository.UserRepository;
import com.cuixx.es.sys.user.utils.UserLogUtils;
