...
import com.cuixx.es.common.repository.support.SimpleBaseRepositoryFactoryBean;
import com.cuixx.es.sys.auth.service.UserAuthService;
import com.cuixx.es.sys.user.entity.User;
import com.cuixx.es.sys.user.exception.*;
